...
#### 信号通知
预分配遇到的问题就是在单个线程用完预分配值需要获取当前所有线程的计数来推算下一次预分配值。之前的方案是通过CAS获取，代价是每次计数都需要CAS保证安全。如果采用信号通知的方式通知其他线程主动同步计数就bu'cun'z
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzU5MTQ3OTg0LDc1NjIwNzc1NywtMTc2OT
Y4NDQ1OCw4MDEwMjcyNDIsMjAxOTE4NDMyNCwtMTQxODMyOTY1
NCwtNDM4NDQyNTYxLDczMDk5ODExNl19
-->