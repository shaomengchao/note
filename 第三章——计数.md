...
#### 精确上线
前面因为各个线程没用同步其他线程实际计数值，导致最终计数只能近似。精确计数采用了每次计数都CAS方式保证线程
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMjA2MTUyNSw4MDEwMjcyNDIsMjAxOT
E4NDMyNCwtMTQxODMyOTY1NCwtNDM4NDQyNTYxLDczMDk5ODEx
Nl19
-->