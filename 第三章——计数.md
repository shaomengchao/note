...
#### 信号通知
每次CAS代价还是有点大，可以利用信号异步通知的方式解决。预分配遇到的问题就是在单个线程用完预分配值需要获取当前s
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4NTAwMDA0Myw3NTYyMDc3NTcsLTE3Nj
k2ODQ0NTgsODAxMDI3MjQyLDIwMTkxODQzMjQsLTE0MTgzMjk2
NTQsLTQzODQ0MjU2MSw3MzA5OTgxMTZdfQ==
-->